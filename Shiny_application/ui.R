...
shinyUI(
        ...
        navbarPage(
                ...
                tabPanel(
                        ...
                        h3("Developing Data Products course ", align = "center"),
                        h4("Shiny Application and Reproducible Pitch", align = "center"),
                        
                        
                        h5("Antonio Avella",align = "center"),
                        h6("September 6 2018",align = "center"),
                        br(),
                        
                        p("This application shows an example of web application using R and ",
                          a(href = "https://shiny.rstudio.com/", "Shiny library"),
                          ", corresponding to the assigment of the week 4,",
                        ...
                        p("Source code of this application is available at",
                          a(href = "https://github.com/Hetman70/Yes-but-how-much-does-it-consume-",
                            "https://github.com/Hetman70/Yes-but-how-much-does-it-consume-")
                        )
                ...
                tabPanel(
                        ...
                        sidebarPanel(
                                ...
                                sliderInput("cyl", "Cylinders", min = minCylinders, max = maxCylinders, value = defaultCar$cyl, step = 2),
                                ...
                                bsTooltip(id = "disp", title = "Engine displacement in cube inch", placement = "right", options = list(container = "body")),
                                
                                sliderInput("hp", "Power", min = minHp, max = maxHp, value = defaultCar$hp, step = 1),
                                bsTooltip(id = "hp", title = "Engine gross horsepower in HP", placement = "right", options = list(container = "body")),
